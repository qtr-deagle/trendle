...
const AppContent = () => (
  <Routes>
    ...
    <Route path="/explore" element={<LandingRoute><LandingExplore /></LandingRoute>} />
    <Route path="/communities" element={<LandingRoute><LandingCommunities /></LandingRoute>} />

    {/* Dashboard Routes (Protected) */}
    <Route path="/dashboard/home" element={<ProtectedRoute><DashboardRoutes /></ProtectedRoute>} />
    <Route path="/dashboard/explore" element={<ProtectedRoute><DashboardRoutes /></ProtectedRoute>} />
    <Route path="/dashboard/communities" element={<ProtectedRoute><DashboardRoutes /></ProtectedRoute>} />
    <Route path="/dashboard/inbox" element={<ProtectedRoute><DashboardRoutes /></ProtectedRoute>} />
    <Route path="/dashboard/account" element={<ProtectedRoute><DashboardRoutes /></ProtectedRoute>} />
